  ...
  <body class="h-vh-100 bg-brandColor2">
    ...
    <h1 class="fg-brandColor2" align="center">Registrasi</h1>
        <div class="form-group cell-6  offset-3">
            ...
            <input type="text" id="id" name="id" placeholder="Masukan Username"/>
        ...
        <div class="form-group cell-6  offset-3">
            <label for="password2">No Telephone</label>
            <input type="password" id="no_telephone" name="no_telephone" placeholder="Masukan Kembali Password Anda"/>
            <small class="text-muted">Masukkan No Telephone</small>
        </div>
        <div class="form-group cell-6  offset-3">

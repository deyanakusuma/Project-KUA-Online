...
$db1=mysqli_query($conn, "SELECT * FROM deadpr WHERE id='$id' ");
$db2=mysqli_query($conn, "SELECT * FROM ortuman WHERE id='$id' ");
$db3=mysqli_query($conn, "SELECT * FROM verif1 WHERE id='$id' ");
$laki = mysqli_fetch_array($db);
$deadpr = mysqli_fetch_array($db1);
...
echo '<table border="0">
  <tr>
    ...
    <td width="30"><h4>:</h4></td>
    <td width="250"><h4>'.$deadpr['nama_expr'].'</h4></td>
  </tr>
  <tr>
    <td><h4>2. Bin / Binti</h4></td>
    <td><h4>:</h4></td>
    <td><h4>'.$deadpr['binti'].'</h4></td>
  </tr>
  <tr>
    <td><h4>3. Tempat tanggal lahir</h4></td>
    <td><h4>:</h4></td>
    <td><h4>'.$deadpr['ttl_expr'].'</h4></td>
  </tr>
   <tr>
    <td><h4>4. Warga negara</h4></td>
    <td><h4>:</h4></td>
    <td><h4>'.$deadpr['warga_expr'].'</h4></td>
  </tr>
  <tr>
    <td><h4>5. Agama</h4></td>
    <td><h4>:</h4></td>
    <td><h4>'.$deadpr['agama_expr'].'</h4></td>
  </tr>
  <tr>
    <td><h4>6. Pekerjaan terakhir</h4></td>
    <td><h4>:</h4></td>
    <td><h4>'.$deadpr['kerjaakhir_pr'].'</h4></td>
  </tr>
  <tr>
    <td><h4>7. Tempat tinggal terakhir</h4></td>
    <td><h4>:</h4></td>
    <td><h4>'.$deadpr['tinggalakhir_pr'].'</h4></td>
  </tr>
  </table>';
echo "<h4>"."telah meninggal dunia pada tanggal : ".$deadpr['tgldead_pr']."</h4>";
echo "<h4>"."di : ".$deadpr['tmpdead_pr']."</h4>";
echo '<table border="0">
  <tr>
    <td width="250"><h4>1. Nama lengkap atau alias</h4></td>
    <td width="30"><h4>:</h4></td>
